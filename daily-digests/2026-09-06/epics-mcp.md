...
tech_stack: ["Python", "p4p", "EPICS", "Model Context Protocol (MCP)", "Channel Access", "PVAccess", "ChannelFinder", "Archiver Appliance", "Phoebus Alarm Logger", "Olog Logbook"]
quality_score: 9
rag_relevance: 9
deployment_complexity: "Medium"
tags: ["EPICS", "control systems", "MCP server", "PV monitoring", "AI integration"]
