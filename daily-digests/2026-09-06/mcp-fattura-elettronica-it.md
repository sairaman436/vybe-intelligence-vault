...
engine: "v2"
category: "Tooling"
tech_stack: ["Python", "Model Context Protocol (MCP)", "FatturaPA XML", "XSD Schema Validation", "Digital Signatures (XAdES-BES, CAdES-BES)", "SOAP (SDICoop)", "Pydantic", "lxml", "Apache 2.0"]
quality_score: 9
rag_relevance: 8
deployment_complexity: "Medium"
tags: ["electronic invoicing", "FatturaPA", "SDI compliance", "MCP server", "Italian tax compliance"]
